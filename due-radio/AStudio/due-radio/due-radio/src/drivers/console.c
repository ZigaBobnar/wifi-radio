...
void console_process_input() {
    if (console_rx_line_ready > 0) {
        ...
        do {
            ...
            if (current_char != '\n') {
                input_line[input_line_index++] = (char)current_char;
            }
        ...
        if (strcmp("esp stop_stream", input_line) == 0) {
            //esp_module_stop_stream();
        } else if (strcmp("esp start_stream", input_line) == 0) {
            //esp_module_start_stream();
        } else if (strcmp("esp wifi_connect", input_line) == 0) {
            esp_module_wifi_connect(WIFI_SSID, WIFI_PASSWORD);
        } else if (strcmp("restart", input_line) == 0) {
