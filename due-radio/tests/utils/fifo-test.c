...
TEST_F(fifo_create_correctStructure) {
    ...
    TEST_ASSERT_EQUAL(fifo->buffer_start, fifo->read_ptr);
    TEST_ASSERT_EQUAL(fifo->buffer_start, fifo->write_ptr);
...
TEST_F(fifo_read_single_getsCorrectPreSetValue) {
    ...
    *(fifo->write_ptr++) = 244;
    ...
    TEST_ASSERT_EQUAL(fifo->read_ptr, fifo->write_ptr);
...
TEST_F(fifo_write_single_fifoFull) {
    ...
    TEST_ASSERT_EQUAL(original_write, fifo->write_ptr);
    TEST_ASSERT_EQUAL(original_read, fifo->read_ptr);
...
TEST_F(fifo_write_single_toStart) {
    ...
    TEST_ASSERT_EQUAL(original_read, fifo->read_ptr);
    TEST_ASSERT_EQUAL(original_write + 1, fifo->write_ptr);
...
TEST_F(fifo_write_single_multipleInMiddle) {
    ...
    TEST_ASSERT_EQUAL(original_read, fifo->read_ptr);
    TEST_ASSERT_EQUAL(original_write + 2, fifo->write_ptr);
    TEST_ASSERT_EQUAL(62, *fifo->read_ptr);
...
TEST_F(fifo_write_single_multipleOnEndRollover) {
    ...
    TEST_ASSERT_TRUE(fifo_write_single(fifo, 62));
    TEST_ASSERT_EQUAL(original_read, fifo->read_ptr);
    TEST_ASSERT_EQUAL(fifo->buffer_end, fifo->write_ptr);
    TEST_ASSERT_EQUAL(62, *fifo->read_ptr);
    TEST_ASSERT_EQUAL(0, *fifo->write_ptr);
    ...
    TEST_ASSERT_EQUAL(original_read, fifo->read_ptr);
    TEST_ASSERT_EQUAL(fifo->buffer_start + 1, fifo->write_ptr);
    TEST_ASSERT_EQUAL(62, *fifo->read_ptr);
    TEST_ASSERT_EQUAL(21, *(fifo->read_ptr + 1));
...
TEST_F(fifo_reset_resetsToBufferBegin) {
    ...
    TEST_ASSERT_EQUAL(fifo->buffer_start + 2, fifo->write_ptr);
    TEST_ASSERT_EQUAL(fifo->buffer_start + 1, fifo->read_ptr);
...
TEST_F(fifo_peek_single_peekMultipleTimesReadMovingForward) {
    ...
    TEST_ASSERT_EQUAL(original_read + 1, fifo->read_ptr);
    TEST_ASSERT_EQUAL(original_write, fifo->write_ptr);
    TEST_ASSERT_TRUE(fifo_read_single(fifo, NULL));
    TEST_ASSERT_TRUE(fifo_peek_single(fifo, &value));
    TEST_ASSERT_EQUAL(56, value);
    TEST_ASSERT_EQUAL(original_read + 2, fifo->read_ptr);
    TEST_ASSERT_EQUAL(original_write, fifo->write_ptr);
